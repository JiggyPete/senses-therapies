class TreatmentsController < ApplicationController
  ...
  private
    ...
    def treatment_params
      params.require(:treatment).permit(:date_of_treatment, :client_name, :venue, :consent, :contra_indications, :assessment, :daily_goal, :aromatherapy, :reflexology, :other_therapy, :grapeseed, :sweet_almond, :resehip, :other_oils, :essentail_oils, :music, :lighting, :outcome)
    end
end
